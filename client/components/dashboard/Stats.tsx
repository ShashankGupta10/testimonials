    ...
    <LoadingAndErrorWrapper isLoading={isLoading} error={error}>
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{data?.spaces}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{data?.videoTestimonials}</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Best Space</CardTitle>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
